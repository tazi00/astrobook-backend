...
export async function consultationRoutes(app: FastifyInstance) {
  ...
  }, astroController.upsertService)

  app.get('/consultation/services/mine', {
    preHandler: [authenticate, requireRole(['astrologer', 'admin'])],
  }, astroController.getMyServices)

  app.delete('/consultation/services/:id', {
    preHandler: [authenticate, requireRole(['astrologer', 'admin'])],
  ...
  app.get('/consultation/astrologers/:id/services', {
    schema: {
  ...
  app.get('/consultation/astrologers/:id/available-dates', {
    schema: {
      params: { type: 'object', properties: { id: { type: 'string' } } },
    },
  ...
  // Single appointment
  app.get('/consultation/appointments/:id', {
    preHandler: [authenticate],
    schema: {
      params: { type: 'object', properties: { id: { type: 'string' } } },
    },
  ...
  app.post('/consultation/appointments/:id/join', {
    preHandler: [authenticate],
    schema: {
      params: { type: 'object', properties: { id: { type: 'string' } } },
    },
  ...
  app.post('/consultation/appointments/:id/end', {
    preHandler: [authenticate, requireRole(['astrologer', 'admin'])],
    schema: {
      params: { type: 'object', properties: { id: { type: 'string' } } },
    },
  ...
  app.post('/consultation/service-requests', {
    preHandler: [authenticate, requireRole(['astrologer', 'admin'])],
  }, srController.createRequest)

  app.patch('/consultation/service-requests/:id', {
    preHandler: [authenticate],
    schema: {
      params: { type: 'object', properties: { id: { type: 'string' } } },
    },
  ...
  app.get('/consultation/service-requests/mine', {
    preHandler: [authenticate],
